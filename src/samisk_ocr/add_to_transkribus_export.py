...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "input_dir",
        type=Path,
        help="Path to transkribus export job (directory with directories with alto/, page/ and metadata.xml",
    )
    parser.add_argument("output_dir", type=Path, help="Path to larger transkribus export dir")
    parser.add_argument(
        "--overwrite",
        action="store_true",
    ...
    setup_logging(source_script="add_to_transkribus_export", log_level="DEBUG")
    ...
    for sub_dir in args.input_dir.iterdir():
